package com.banmingi.communityplus.auth;
...
public class AuthAspect {
     ...
     * @return
     */
    @Around("@annotation(com.banmingi.communityplus.auth.annotations.CheckLogin)")
     ...
     * @throws Throwable
     */
    @Around("@annotation(com.banmingi.communityplus.auth.annotations.CheckAuthorization)")
